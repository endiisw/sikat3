        ...
        <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row md:gap-y-0">
            ...
            <div class="flex w-full items-center justify-between gap-x-4 md:w-auto">
                ...
                <a class="btn btn-primary" href="{{ route('admin.users.create') }}" role="button">
                    ...
                    <span class="hidden sm:inline-block">Tambah User</span>
                </a>
            </div>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="w-[10%] uppercase">Role</th>
                        <th class="w-[10%] uppercase">Registered At</th>
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            <td><input class="checkbox product-checkbox" type="checkbox" /></td>
                            <td>{{ $user->name }}</td>
                            <td>{{ $user->email }}</td>
                            <td>
                                <div class="badge badge-soft-success">{{ $user->roles?->first()?->name ?? '-' }}</div>
                            </td>
                                    ...
                                    <div class="dropdown" data-placement="bottom-start">
                                        ...
                                        <div class="dropdown-content w-40">
                                            <ul class="dropdown-list">
                                                ...
                                                <li class="dropdown-list-item">
                                                    <a href="{{ route('admin.users.edit', $user) }}" class="dropdown-link">
