...
<head>
    ...
    <link rel="icon" href="{{ asset('images/logo-konstruksi.png') }}" type="image/svg+xml" />
    ...
    <div id="app" class="flex min-h-screen w-full items-center justify-center">
        ...
        <main>
            <div class="flex flex-col items-center justify-center">
                <p class="text-6xl font-semibold text-primary-500">@yield('code')</p>
                <p class="mt-2 text-lg">@yield('message')</p>
                <a href="{{ route('admin.home.index') }}">
                    <button class="btn btn-primary mt-8 px-8 py-2">
